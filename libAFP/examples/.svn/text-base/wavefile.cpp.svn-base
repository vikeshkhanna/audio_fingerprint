...
#define MAX_SAMPLE_SIZE 135  //in seconds, original 135
...
AudioData* loadWaveFile(char *file) {
    ...
    // No need to read the whole file, just the first min of max_sample_size and ms
    int sampleSize = min((int)ms*1000,MAX_SAMPLE_SIZE);
