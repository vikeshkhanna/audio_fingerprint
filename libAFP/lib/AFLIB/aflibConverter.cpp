...
void aflibConverter::deleteMemory()
{
   int i;
...
void aflibConverter::initialize(
   double fac,
   int    channels,
   double volume)
{
...
int aflibConverter::resample(       /* number of output samples returned */
...
int aflibConverter::err_ret(char *s)
{
//    aflib_debug("resample: %s \n\n",s); /* Display error message  */
	return -1;
}

int aflibConverter::readData(
...
int aflibConverter::resampleFast(  /* number of output samples returned */
    int& inCount,		/* number of input samples to convert */
    int outCount,		/* number of output samples to compute */
    short inArray[],            /* input data */
    short outArray[])           /* output data */
...
int aflibConverter::resampleWithFilter(  /* number of output samples returned */
    int& inCount,		/* number of input samples to convert */
    int outCount,		/* number of output samples to compute */
    short inArray[],            /* input data */
    short outArray[],           /* output data */
